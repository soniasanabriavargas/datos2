...
<html lang="en">
	...
	<!--///////////////////////////////////////////////////Inicia cuerpo interno///////////////////////////////-->
		     <div class="container">
				...
				$consulta="SELECT * FROM sponsors WHERE id=$id";
		       ...
		       <h1>DELETE SPONSORS</h1>
		         <div class="center">
					<form action="ejecutareliminarsponsors.php" method="post">
							<!--Id<br>-->
							...
							Status type<br> 
							<input type="text" name="statustype" value="<?php echo $statustype?>" readonly="readonly"><br><br>
